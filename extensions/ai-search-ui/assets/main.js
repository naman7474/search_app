/* AI Search App - Built 2025-07-09T09:14:36.119Z */
"use strict";
var AISearchApp = (() => {
  ...
  var ConversationalSearch = ({ shopUrl, appProxyUrl, onProductClick, formatPrice, onClose }) => {
    ...
    const [suggestedResponses, setSuggestedResponses] = (0, import_react.useState)([]);
    ...
    const sendMessage = (content) => __async(void 0, null, function* () {
      ...
      try {
        ...
        const response = yield fetch(conversationUrl, {
          method: "POST",
          headers: {
        ...
        console.error("Conversation failed:", error2);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "conversational-search", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "conversation-header", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: "Chat with AI Assistant" }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "conversation-messages", children: [
        messages.map((message, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              ...
              message.timestamp && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "message-timestamp", children: new Date(message.timestamp).toLocaleTimeString([], {
                hour: "2-digit",
                minute: "2-digit"
              }) })
            ]
        ...
        isLoading && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "conversation-message assistant-message", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "message-content", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "typing-indicator", children: [
      ...
      products.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "conversation-products", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", { children: "Recommended Products" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "conversation-products-grid", children: products.map((product) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "product-card-info", children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h5", { className: "product-card-title", children: product.title }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "product-card-price", children: formatPrice(product.price_min) }),
                product.vendor && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "product-card-vendor", children: [
                  "by ",
                  product.vendor
                ] })
              ] })
      ...
      suggestedQuestions.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "conversation-suggestions", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h5", { children: "Suggested questions:" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "suggestion-buttons", children: suggestedQuestions.map((question, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "button",
          {
      ...
      suggestedResponses.length > 0 && !suggestedQuestions.length && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "conversation-suggestions", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h5", { children: "You might be interested in:" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "suggestion-buttons", children: suggestedResponses.map((response, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "button",
          {
            className: "suggestion-button",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("form", { className: "conversation-input-form", onSubmit: handleInputSubmit, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "conversation-input-wrapper", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "input",
          {
            ref: inputRef,
      ...
      error && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "conversation-error", children: error })
    ] });
  };
  var AISearchApp = () => {
    ...
    const [error, setError] = (0, import_react.useState)(null);
    const [searchMode, setSearchMode] = (0, import_react.useState)("traditional");
    ...
    const shopUrl = ((_a = rootElement == null ? void 0 : rootElement.dataset) == null ? void 0 : _a.shopUrl) || ((_b = window.Shopify) == null ? void 0 : _b.shop) || "";
    const appProxyUrl = ((_c = rootElement == null ? void 0 : rootElement.dataset) == null ? void 0 : _c.appProxyUrl) || "/apps/xpertsearch";
    const displayMode = ((_d = rootElement == null ? void 0 : rootElement.dataset) == null ? void 0 : _d.displayMode) || ((_e = window.AISearchConfig) == null ? void 0 : _e.displayMode) || "bar";
    const resultsLimit = parseInt(((_f = rootElement == null ? void 0 : rootElement.dataset) == null ? void 0 : _f.resultsLimit) || ((_g = window.AISearchConfig) == null ? void 0 : _g.resultsLimit) || 10, 10);
    const placeholderText = ((_h = rootElement == null ? void 0 : rootElement.dataset) == null ? void 0 : _h.placeholder) || ((_i = window.AISearchConfig) == null ? void 0 : _i.placeholderText) || "Search for products...";
    (0, import_react.useEffect)(() => {
    ...
    const performSearch = (searchQuery) => __async(void 0, null, function* () {
    ...
    const formatPrice = (price) => {
      ...
      if (!price)
        return "Price varies";
      const currency = ((_b2 = (_a2 = window.Shopify) == null ? void 0 : _a2.currency) == null ? void 0 : _b2.active) || "USD";
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      ...
      isModalOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "ai-search-modal-overlay", onClick: closeModal, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "ai-search-modal", onClick: (e) => e.stopPropagation(), children: searchMode === "conversational" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "modal-header", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "modal-search-input-wrapper", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "input",
              {
                ref: modalInputRef,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "modal-mode-toggle", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "button",
              {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "button",
              {
                ...
                type: "button",
                children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChatIcon, {})
              }
            )
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "modal-content", children: isLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "search-loading", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "loading-spinner" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Searching..." })
        ] }) : error ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "search-error", children: error }) : results.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "search-results-grid", children: results.map((product) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "result-card-info", children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "result-card-title", children: product.title }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "result-card-price", children: formatPrice(product.price_min) }),
                product.vendor && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "result-card-vendor", children: [
                  "by ",
                  product.vendor
                ] }),
                product.similarity_score && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "result-card-score", children: [
          ...
          product.id || product.shopify_product_id
        )) }) : query.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "no-results-message", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SearchIcon, {}),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Try different keywords or check your spelling" })
        ] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "search-prompt", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SearchIcon, {}),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: "Start typing to search" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Search will begin automatically after 3 seconds, or press Enter to search immediately" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "search-mode-hint", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
            "\u{1F4A1} ",
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Try the AI Chat mode" }),
            " - Click the ",
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChatIcon, {}),
            " icon for conversational search!"
          ] }) })
        ] }) })
      ] }) }) })
    ] });
